...
<body style="background-image: url("{{\Illuminate\Support\Facades\URL::asset('css/login/login-bg.jpg')}}")">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="login-wrap py-5">
                    <div class="img d-flex align-items-center justify-content-center" style="background-image: url(image/logo.png);"></div>
